...
import { approveMentoringActivitySql } from "@/server/modules/rewards/commands";
...
export async function POST(request: Request, { params }: RouteParams) {
  ...
  try {
    ...
    return commandSuccess(await approveMentoringActivitySql(context, id, body.reason), requestId);
  } catch (error) {
